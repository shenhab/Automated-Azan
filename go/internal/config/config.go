...
type ChannelConfig struct {
	...
	BrowserAthan   bool `toml:"browser_athan"`   // play athan audio in the browser
}
...
func (c *Config) AsWebDict() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"ch_fajr_speaker": c.Prayer.Channels.Fajr.Speaker, "ch_fajr_local": c.Prayer.Channels.Fajr.Local, "ch_fajr_notify": c.Prayer.Channels.Fajr.Notify, "ch_fajr_browser": c.Prayer.Channels.Fajr.BrowserNotify, "ch_fajr_browser_athan": c.Prayer.Channels.Fajr.BrowserAthan,
		"ch_dhuhr_speaker": c.Prayer.Channels.Dhuhr.Speaker, "ch_dhuhr_local": c.Prayer.Channels.Dhuhr.Local, "ch_dhuhr_notify": c.Prayer.Channels.Dhuhr.Notify, "ch_dhuhr_browser": c.Prayer.Channels.Dhuhr.BrowserNotify, "ch_dhuhr_browser_athan": c.Prayer.Channels.Dhuhr.BrowserAthan,
		"ch_asr_speaker": c.Prayer.Channels.Asr.Speaker, "ch_asr_local": c.Prayer.Channels.Asr.Local, "ch_asr_notify": c.Prayer.Channels.Asr.Notify, "ch_asr_browser": c.Prayer.Channels.Asr.BrowserNotify, "ch_asr_browser_athan": c.Prayer.Channels.Asr.BrowserAthan,
		"ch_maghrib_speaker": c.Prayer.Channels.Maghrib.Speaker, "ch_maghrib_local": c.Prayer.Channels.Maghrib.Local, "ch_maghrib_notify": c.Prayer.Channels.Maghrib.Notify, "ch_maghrib_browser": c.Prayer.Channels.Maghrib.BrowserNotify, "ch_maghrib_browser_athan": c.Prayer.Channels.Maghrib.BrowserAthan,
